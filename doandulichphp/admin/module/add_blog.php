<form action="" method="post" enctype="multipart/form-data">
  <input type="text" class="form-control" name="ten_nha" placeholder="Tên nhà hàng">
  <input type="text" class="form-control" name="dia_chi" placeholder="Địa chỉ">
   <input type="number" class="form-control" name="gia" placeholder="Giá">
    <textarea  rows="8" cols="" title="Viết nội dung cho nhà hàng" class="tipS" name="noidung" style="width: 100%"></textarea>
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $upload =  mysqli_query($connect,"insert into nhahang (ten,diachi,noidung,gia,hinh) values ('$ten','$diachi','$noidung','$gia','$hinh')
        ");
        if ($upload) {
