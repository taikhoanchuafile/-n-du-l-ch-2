<form action="" method="post" enctype="multipart/form-data">
  <input type="text" class="form-control" name="ten" placeholder="Tên phương tiện">
  <input type="text" class="form-control" name="chongoi" placeholder="Số lượng chỗ ngồi">
   <input type="number" class="form-control" name="gia" placeholder="Giá">
    <textarea  rows="8" cols="" title="Viết nội dung cho phương tiện" class="tipS" name="noidung" style="width: 100%"></textarea>
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $upload =  mysqli_query($connect,"insert into phuongtien (ten,chongoi,gia,hinh,noidung) values ('$ten','$chongoi','$gia','$hinh','$noidung')
        ");
        if ($upload) {
