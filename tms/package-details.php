...
<html>
<head>
<title>VT | Chi tiết các gói </title>
...
<div class="banner-3">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> VT- Chi tiết các gói </h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
