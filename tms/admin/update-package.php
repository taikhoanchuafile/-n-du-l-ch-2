...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a><i class="fa fa-angle-right"></i>Cập nhật gói </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
  	       <h3>Cập nhật gói</h3>
				...
				else if($msg){?><div class="succWrap"><strong>Trạng thái</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Vị trí gói</label>
									<div class="col-sm-8">
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Giá trọn gói tính bằng USD</label>
									<div class="col-sm-8">
...
<div class="col-sm-8">
<img src="pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId);?>">Đổi hình</a>
</div>
</div>

<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Lần cập nhật cuối</label>
									<div class="col-sm-8">
