...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a><i class="fa fa-angle-right"></i>Cập nhật dữ liệu </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Cập nhật dữ liệu</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="manage-pages.php?type=terms">Pháp lý</option>
                  <option value="manage-pages.php?type=privacy"> Chính sách Quyền riêng tư</option>
                  <option value="manage-pages.php?type=aboutus">Về chúng tôi</option> 
                  <option value="manage-pages.php?type=contact"> Liên lạc với chúng tôi </option>
                </select>
									</div>
								</div>
<div class="form-group">
			...
			switch($_GET['type'])
			{
				...
				case "privacy" :
									echo "Chính sách Quyền riêng tư";
									break;
				...
				case "objectives" :
									...
									break;						
				case "disclaimer" :
									echo " Từ chối trách nhiệm";
									break;
				case "vbnet" :
									echo " Trở thành đối t";
									break;
				case "candc" :
									echo "Super Brand";
									break;
