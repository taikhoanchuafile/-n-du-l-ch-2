...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Cập nhật đánh dấu!</b></div></td>
      ...
      <td colspan="2" ">  <?php if($error){?><div class="errorWrap"><strong>Lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } 
        else if($msg){?><div class="succWrap"><strong>Trạng thái</strong>:<?php echo htmlentities($msg); ?> </div><?php }?></td>
...
?>
    ...
    <?php } else { ?>
     <tr>
      <td class="fontkink1" ><b>Đánh dấu:</b></td>
