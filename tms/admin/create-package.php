...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="packagefeatures" id="packagefeatures" placeholder="Chi tiết" required>
									</div>
								</div>		
...
<div class="form-group">
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<button type="reset" class="btn-inverse btn">Tạo lại</button>
			</div>
		</div>
	</div>
</form>
