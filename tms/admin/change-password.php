...
<html>
<head>
<title>VT | Admin đổi mật khẩu </title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a><i class="fa fa-angle-right"></i>Profile <i class="fa fa-angle-right"></i> Đổi mật khẩu</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
