...
<html>
<head>
<title>VT | Admin Trang chủ </title>
...
<!--header end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
