...
<html>
<head>
<title> VT | Quản lý yêu cầu </title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Trang chủ</a><i class="fa fa-angle-right"></i>Quản lý HDV</li>
            </ol>
...
<td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Bạn có thực sự muốn đọc!')" >Pending</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
